        ...
        <>
            ...
            <Box sx={{ display: 'flex', bgcolor: 'rgb(232, 232, 232)' }}>
                ...
                <div className=" col-sm-10">
                    ...
                    <Box sx={{ display: 'flex', m: 2 ,width:'1120px'}}>
                        <div className="col-sm-2 bg-white m-2 p-4">
                            ...
                            <RadioGroup row >
                                ...
                                <FormControlLabel value="Nearby States" control={<Radio />} label="Nearby States" />
                                <FormControlLabel value="New Delhi" control={<Radio />} label="New Delhi" />
                                <FormControlLabel value="Foreign" control={<Radio />} label="Foreign" />
                                <FormControlLabel value=" All Locations" control={<Radio />} label=" All Locations" />
                            </RadioGroup>
                        </div>
                        <div className="col-sm-2 bg-white m-2 p-4">
                        ...
                        <div className="col-sm-2 bg-white m-2 p-4" style={{width:'220px'}}>
                            <Typography sx={{ fontWeight: 'bold' }}>Order Value (₹)</Typography>
                            <RadioGroup row >

                                <FormControlLabel value="Above 10,000" control={<Radio />} label="Above 10,000" />
                                <FormControlLabel value="Above 50,000" control={<Radio />} label="Above 50,000" />
                                <FormControlLabel value="Above 1 Lakh" control={<Radio />} label="Above 1 Lakh" />
                                <FormControlLabel value="Above 10 Lakh" control={<Radio />} label="Above 10 Lakh" />
                                <FormControlLabel value="Above 50 Lakh" control={<Radio />} label="Above 50 Lakh" />
